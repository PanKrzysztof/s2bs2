...
class Page extends \AppBundle\Entity\Page implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Page' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Page' . "\0" . 'content', '' . "\0" . 'AppBundle\\Entity\\Page' . "\0" . 'imie', '' . "\0" . 'AppBundle\\Entity\\Page' . "\0" . 'nazwisko', '' . "\0" . 'AppBundle\\Entity\\Page' . "\0" . 'wiek', '' . "\0" . 'AppBundle\\Entity\\Page' . "\0" . 'numer');
        }
    ...
    public function setWiek($wiek)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setWiek', array($wiek));

        return parent::setWiek($wiek);
    }
    ...
    public function getWiek()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getWiek', array());

        return parent::getWiek();
    }
    ...
    public function setNumer($numer)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setNumer', array($numer));
    ...
    public function getNumer()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getNumer', array());
