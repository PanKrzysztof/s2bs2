...
use BookWebBundle\Form\BookType;
...
class BookController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('BookWebBundle:Book')->findAll();
     ...
     * @Method("POST")
     * @Template("BookWebBundle:Book:new.html.twig")
     */
    ...
    */
     ...
     * @Method("PUT")
     * @Template("BookWebBundle:Book:edit.html.twig")
     */
